...
from models import screen_sponsors_settings
...
screen_sponsors = Screen(
    'screen_sponsors.html',
    'screen_sponsors',

    #optional params
    duration=300000,
    settings=screen_sponsors_settings,
    #hide='fade', 
    #show='fade',
    slideshow=True,
    js_init ='screen_sponsors_init',
    js_start='screen_sponsors_start',
    js_stop ='screen_sponsors_stop',
    js_onWinResize = 'screen_sponsors_onScreenResize'
)
