...
from models import screen_wifi_bandwidth_settings
...
screen_wifi_bandwidth = Screen(
    'screen_wifi_bandwidth.html',
    'screen_wifi_bandwidth',

    #optional params
    duration=300000,
    settings=screen_wifi_bandwidth_settings,
    #hide='fade', 
    #show='fade',
    slideshow=True,
    js_init ='screen_wifi_bandwidth_init',
    js_start='screen_wifi_bandwidth_start',
    js_stop ='screen_wifi_bandwidth_stop',
    js_onWinResize = 'screen_wifi_bandwidth_onWinResize'
)
