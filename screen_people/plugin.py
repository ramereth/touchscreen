...
from models import screen_people_settings
...
screen_people = Screen(
    'screen_people.html',
    'screen_people',

    #optional params
    duration=300000,
    settings=screen_people_settings,
    #hide='fade', 
    #show='fade',
    slideshow=True,
    js_init ='screen_people_init',
    js_start='screen_people_start',
    js_stop ='screen_people_stop',
    js_onWinResize = 'screen_people_onScreenResize'
)
