...
DATABASE_NAME = 'bigger'             # Or path to database file if using sqlite3.
DATABASE_USER = 'bigger'             # Not used with sqlite3.
DATABASE_PASSWORD = 'bigger'         # Not used with sqlite3.
