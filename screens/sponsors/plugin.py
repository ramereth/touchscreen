...
from models import sponsors_settings
...
sponsors = Screen(
    ...
    #optional params
    duration=300000,
    settings=sponsors_settings,
    #hide='fade', 
    #show='fade',
    slideshow=True,
    js_init ='sponsors_init',
    js_start='sponsors_start',
    js_stop ='sponsors_stop',
    js_onWinResize = 'sponsors_onScreenResize'
)
